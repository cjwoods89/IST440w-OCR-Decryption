...
import { EncryptionModalComponent } from '../../shared/components/encryption-modal/encryption-modal.component';
...
export class ProjectsComponent implements OnInit {
    ...
    openEncryptionModal() {
        this.modalRef = this.modalService.show(EncryptionModalComponent, this.modalConfig);
